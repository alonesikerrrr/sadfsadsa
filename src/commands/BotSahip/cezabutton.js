...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    client.api.channels(message.channel.id).messages.post({
      data: {
        "content": `❗️ Aşağıda ki düğmelerden cezalarınız hakkında detaylı bilgi alabilirsiniz.`, "components": [{
          "type": 1, "components": [

            { "type": 2, "style": 2, "custom_id": "cezapuan", "label": "Ceza Puanım", "emoji": { "name": "❔" } },
            { "type": 2, "style": 2, "custom_id": "cezalarım", "label": "Cezalarım", "emoji": { "name": "❔" } },
            { "type": 2, "style": 2, "custom_id": "kalanzaman", "label": "Kalan Zamanım?", "emoji": { "name": "❔" } }
