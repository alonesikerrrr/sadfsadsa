...
.setDescription(`
<a:vendora:1221466255991635998> **__V E N D O R A Yetkili Başvuru Formu__** <a:vendora:1221466255991635998>
...
`) 
      ...
      .addComponents(
      new MessageButton().setCustomId("ytbaşvuruu").setLabel("Yetkili Başvurusu İçin Tıkla").setStyle("SUCCESS"),
     );
  ...
  client.on("interactionCreate", async (wsi) => {
      ...
      .addComponents(
        ...
        .setMinLength(10)
        .setMaxLength(400)
        .setPlaceholder('Örn : Sunucunuza Yeni Üyeler Getiririm')
        .setRequired(true),
        new TextInputComponent()
        ...
        .setMinLength(5)
        .setMaxLength(100)
        .setPlaceholder('Lütfen buraya yazın. / Örn: Discordda takılmayı severim.')
        .setRequired(true)
      );
...
.setColor("RANDOM")
.setDescription(`
<a:prizma:1218296848767389726> <@${kblkullanıcı.user.id}> Tebrikler Başvurun ${wsi.user.toString()} Tarafından **Kabul Edildi** Artık Sende Bir Yetkilisin
...
await client.channels.cache.get(conf.başvurudurum).send({ content:`<@${kblkişi}>`,embeds: [kabullletttikkk]})
        db.delete(wsi.message.id)
         ...
         kblkullanıcı.roles.add("1221442218787606538")
      kblkullanıcı.roles.add("1221442223556530256")
...
.setColor("RANDOM")
.setDescription(`
<a:prizma:1214258207560695822> <@${redkişi.user.id}> Malesef Başvurun ${wsi.user.toString()} Tarafından **Red Edildi**
