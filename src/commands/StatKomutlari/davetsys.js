...
<a:bitt:1217922298271502448> Merhaba ${member.toString()} Davet Statların Aşağıda Listelenmiştir.

${miniicon} **Toplam** \`${total}\` **davetin Bulunmakta.**
${miniicon} **Bunlardan** **(**\`${regular}\` **gerçek,** \`${bonus}\` **bonus,** \`${leave}\` **ayrılmış,** \`${fake}\` **fake)**     
${miniicon} **(Günlük:** \`${daily}\` **Davet**, **Haftalık:** \`${weekly}\` **Davet**, **Taglı:** \`${tagged}\` **Davet)**
${miniicon} ${bazıları ? `**Davet Ettiğin Kullanıcılar:** ${bazıları}` : ''}
...
.setDescription(`
<a:bitt:1217922298271502448> ${member.toString()} Kullanıcısının Yaptığı Davetler Aşağıda Belirtilmiştir.`)

.addFields(
{ name: "<a:kirmiziok:1217922896194830406> __**Toplam Davet**__",  value: `
\`\`\`fix
${inviterData ? inviterData.total : 0} Davet
\`\`\`
`, inline: true },
{ name: "<a:kirmiziok:1217922896194830406> __**Fake Davet**__",  value: `
\`\`\`fix
${inviterData ? inviterData.fake : 0} Fake Davet
\`\`\`
`, inline: true },
{ name:"<a:kirmiziok:1217922896194830406> __**Bonus Davet**__",  value: `
\`\`\`fix
...
embeds.addField(`
<a:bitt:1217922298271502448> **Davet İstatistiği**`, `
${miniicon} Toplam Davet **${total}**
${miniicon} Gerçek Davet **${regular}**
${miniicon} Davetinden Çıkanlar **${leave}**
${miniicon} Fake Davet **${fake}**
