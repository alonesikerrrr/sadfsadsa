...
if(!message.channel.name.includes("yönetici-chat")) 
 if(!message.channel.name.includes("register-sorumlusu")) {     
    ...
    embed.setColor("RANDOM").setDescription(`${member.toString()}'n verileri aşağıda verilmiştir.`)
      .addFields(
        {
          name: "<a:bitt:1217922298271502448> **Kullanıcı Bilgileri**", value: `
\`\`\`diff
• Kullanıcı : ${member.user.username}
• Kullanıcı ID : ${message.author.id}
\`\`\`
<:voice:1218277537780858960> **Ses Bilgileri:**
\`\`\`diff
...
\`\`\`
<:Unmute:1217921445921947700> **Metin Bilgileri:**
\`\`\`diff
- Toplam Mesaj: ${messageData ? messageData.topStat : 0} 
\`\`\`
<a:kirmiziok:1217922896194830406> **İnvite Bilgileri:**(\`\`${total}\`\`)
\`\`\`diff
...
\`\`\`
<a:kirmiziok:1217922896194830406> **Kayıt Bilgileri:**(\`\`${data ? data.top : 0}\`\`)
\`\`\`diff
