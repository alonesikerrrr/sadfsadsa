...
module.exports = {
  ...
  run: async (client, message, args, embed) => {
    ...
    .setColor("#2f3136")
    .setDescription(`
<a:bitt:1214235957679886337> Banı Kaldıran Yetkili: ${message.author} \`${message.author.id}\`

${miniicon} Ban Cezası Kaldırılan Üye: \`(${ban.user.username.replace(/\`/g, "")} - ${ban.user.id})\`
${miniicon} Banın Kaldırılma Tarihi: <t:${Math.floor(Date.now() / 1000)}> (<t:${Math.floor(Date.now() / 1000)}:R>)
      `)
