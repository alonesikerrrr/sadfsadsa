...
const { red, green, Mute, revusome, kirmiziok , miniicon} = require("../../configs/emojis.json")
module.exports = {
  conf: {
    aliases: ["vmute","voicemute"],
    name: "vmute",
    help: "vmute <Shadow/ID> <Süre> <Sebep>",
  ...
  run: async (client, message, args, embed) => {
    ...
    if (duration) {
      ...
      .setColor("#2f3136")
      .setDescription(`
<a:bitt:1214235957679886337> ${member.toString()} Adlı Kişiye Ses Mutesi Atıldı
