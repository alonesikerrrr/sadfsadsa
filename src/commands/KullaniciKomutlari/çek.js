...
${miniicon} Odaya Taşınan Kullanıcı: ${member} - \`${member.id}\`
${miniicon} Odasına Taşıyan Yetkili: ${message.author} - \`${message.author.id}\``)
      ...
      collector.on("collect", async (button) => {
        ...
        if (button.customId === "onay") {
          ...
          const embeds = new MessageEmbed()
            ...
            .setTimestamp()
            .setDescription(`${green} ${message.author}, ${member} kişisini yanınıza taşıdınız.`)
          member.voice.setChannel(message.member.voice.channel.id);
        ...
        if (button.customId === "red") {
          ...
          const embedss = new MessageEmbed()
            ...
            .setFooter({ text: message.author.tag, iconURL: message.author.avatarURL({ dynamic: true })})
            .setTimestamp()
            .setDescription(`${red} ${message.author}, ${member} yanına taşıma işlemi iptal edildi.`)
