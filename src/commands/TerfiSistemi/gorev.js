...
const { Muhabbet, gulucuk, mesaj2, galp, staff ,rewards , fill, empty, fillStart, emptyEnd, fillEnd, red, miniicon } = require("../../configs/emojis.json")
...
`${miniicon} **Taglı Üye Durumu :**  
${galp} ${progressBar(tagData ? tagData.tagli : 0, 5, 5)} \`${tagTotal} (${tagTotal}/5)\`
` : "";


message.channel.send({ embeds: [embed.setDescription(`
<:tag3:1221524177043984447> ${member.toString()}, (${member.roles.highest}) rolüne ait görevlerin aşağıda belirtilmiştir. Görevler tamamlandığında tamamladığın görevlerin ödüllerini almak için \`.görevlerim ödül\` komutu ile alabilirsiniz.  
