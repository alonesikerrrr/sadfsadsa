...
.setDescription(`
<a:bitt:1214235957679886337> ${message.author} tarafından ${message.channel} kanalında \`${prefix}${commandName}\` komutu kullanıldı.
                        
${miniicon} Komut Kanalı: ${message.channel} - (\`${message.channel.id}\`)
${miniicon} Komut Sahibi: ${message.author} - (\`${message.author.id}\`)
${miniicon} Komut İçeriği: \`\`\`${message.content}\`\`\`
    `)
